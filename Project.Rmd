...
diffs = abs(table(pass$category) - table(fail$category))
par(mar=c(3,9,1,1))
...
#precision ~ thresh
plot(lrsumm$precision ~ lrsumm$threshold, xlab = "Threshold", ylab = "Precision", pch = 16)
lines(lrsumm$precision ~ lrsumm$threshold)
#recall ~ thresh
plot(lrsumm$recall ~ lrsumm$threshold, xlab = "Threshold", ylab = "recall", pch = 16)
lines(lrsumm$recall ~ lrsumm$threshold)
#ROC Curve
